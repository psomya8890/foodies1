    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontWeight: 800, fontSize: '1.8rem' }}>Kitchen Panel</h1>
          <p style={{ color: 'var(--text-muted)', marginTop: '0.4rem' }}>Sign in to manage incoming orders</p>
        </div>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: '2rem' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
              ...
              <input type="email" placeholder="kitchen@foodapp.com" value={form.email}
            ...
            <button type="submit" className="btn btn-primary" style={{ width: '100%', padding: '0.85rem', marginTop: '0.5rem', fontSize: '1rem' }} disabled={loading}>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.25rem', color: 'var(--text-muted)', fontSize: '0.85rem' }}>
          Default: kitchen@foodapp.com / kitchen123
        </p>
      </div>
    </div>
  );
